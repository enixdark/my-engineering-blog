...
```yml
author_name: # This is the ID of the author
  name: Author name
  thumbnail: /img/authors/author_name.jpg # Use a remote image or add your own image
  github: author # GitHub Username (optional)
```
...
|`excerpt`|Your catchy excerpt that will be shown on the list of blog entries page. Wrap your excerpt in quotes if it spans across multiple lines.|`"Content."`|
